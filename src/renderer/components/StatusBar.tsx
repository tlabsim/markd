...
const StatusBar: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-between px-3 py-1 text-[11px] text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-[#1c2733] border-t border-gray-200 dark:border-gray-700/50">
